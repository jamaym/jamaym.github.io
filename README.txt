...
a persistence unit "HostContactosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "HostContactos\pom.xml":
...
artifact ("HostContactos.war") is already built. You can build
